...
//    button.frame = CGRectMake(10, [[UIScreen mainScreen] applicationFrame].size.height-44, 60, 40);
//    [button addTarget:self action:@selector(previewImages) forControlEvents:UIControlEventTouchUpInside];
...
//    viewController.imageArray = self.imagePickerController.selectedAssetURLs;
